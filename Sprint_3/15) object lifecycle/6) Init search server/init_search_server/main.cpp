...
struct Document {
    ...
    Document(int id_v, double relevance_v, int rating_v)
        : id(id_v), relevance(relevance_v), rating(rating_v)
    {}
...
public:
    ...
    explicit SearchServer(const string& stop_words){
        vector<string> s_words = SplitIntoWords(stop_words);
        stop_words_ = set<string>(s_words.begin(), s_words.end());
    }
...
//    cout << "1)";
//    for(string ch : search_server1.stop_words_){
//        cout << ch;
//    }
//    cout << endl;
...
//    cout << "2)";
//    for(string ch : search_server2.stop_words_){
//        cout << ch;
//    }
//    cout << endl;
...
//    cout << "3)";
//    for(string ch : search_server3.stop_words_){
//        cout << ch;
//    }
//    cout << endl;
