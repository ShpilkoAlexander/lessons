...
void SearchServer::AddDocument(int document_id, std::string_view document, DocumentStatus status, const std::vector<int>& ratings) {
    ...
    for (const std::string_view word : words) {
        SearchServer::word_to_document_freqs_[std::string(word)][document_id] += inv_word_count;
        SearchServer::document_ids_with_word_[document_id][std::string(word)] += inv_word_count;
    }
