...
//        range_size_ = distance(range_begin_, range_end_);
//    }
...
//    vector<Document> output_document = vector<Document>(range.begin(), range.end());
//    for (const auto& document : output_document) {
//        output << "{ " << document << " }";
//    }
...
//        size_t container_size = distance(container_begin_, container_end_);
//        auto range_begin = container_begin_;

//        for(size_t end = 0; end != container_size; end += page_size_) {
//            if (end >= container_size) {
//                pages_.push_back(IteratorRange<Iterator>(range_begin, container_end_));
//                break;
//            }

//            pages_.push_back(IteratorRange<Iterator>(range_begin, next(range_begin, page_size)));
