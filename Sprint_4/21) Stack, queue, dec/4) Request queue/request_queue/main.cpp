...
//        }
//        QueryResult query;
//        query.search_result = search_server_.FindTopDocuments(raw_query, document_predicate);
...
//        }
//        QueryResult query;
//        query.search_result = search_server_.FindTopDocuments(raw_query, status);
//        requests_.push_front(query);
...
//        }
//        QueryResult query;
//        query.search_result = search_server_.FindTopDocuments(raw_query);
//        requests_.push_front(query);
...
//    int GetNoResultRequests() const {
//        auto result = count_if(requests_.begin(), requests_.end(), [] (const QueryResult& query_result){
//                    return query_result.search_result.empty();
//                });
