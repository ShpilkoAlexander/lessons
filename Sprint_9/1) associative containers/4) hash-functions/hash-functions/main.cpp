...
//    bool operator==(VehiclePlate& any_vehicle_plate) {
//        return ToString() == any_vehicle_plate.ToString();
//        //return letters_ == any_vehicle_plate.letters_ && digits_ == any_vehicle_plate.digits_ && region_ == any_vehicle_plate.region_;
//    }

//    bool operator==(const VehiclePlate& any_vehicle_plate) {
//        return ToString() == any_vehicle_plate.ToString();
//        //return letters_ == any_vehicle_plate.letters_ && digits_ == any_vehicle_plate.digits_ && region_ == any_vehicle_plate.region_;
//    }
...
private:
    ...
    bool operator==(VehiclePlate& lhs, VehiclePlate& rhs) {
...
public:
    void Insert(T elem) {
        ...
        if (find(elements_[index].begin(), elements_[index].end(), elem) == elements_[index].end()){
